...
def players_list(page):
    global delete_pop_up, plr_del_btn_state, who_to_del, map_level_menu_state
    # page is 0-indexed
    i = page * 5
    count = 0
...
def map_level_menu(player):
    global menu_state, fade_count, map_level_menu_state, gameplay_state
...
def create_menu():
    ...
    global map_delete_popup_back, map_delete_popup_confirm, map_delete_btn, map_delete_cancel, map_delete_btn_state, map_delete_popup
    ...
    if not map_action_popup and not create_new_map_state:
        if map_delete_popup:
            ...
            title1 = create_text("Are you sure you", 40, white)[0]
            title2 = create_text(f"want to delete", 40, white)[0]
            title3 = create_text(f"'{selected_map}'?", 40, main_color)[0]
            screen.blit(title1, ((1000 - (24 * 16))//2, 268))
            screen.blit(title2, ((1000 - (24 * 16))//2, 316))
            screen.blit(title3, ((1000 - (24 * 16))//2, 364))
